...
contract ClaimAirdrop is Script {
    ...
    //Generated using foundry cli
    //First using cast call <AirdropAddress> getMessageHash to get the hash of the message
    //Then using cass wallet sign --no-hash
